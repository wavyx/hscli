...
export default class ReportConversationsCommand extends BaseCommand {
  ...
  static examples = [
    '<%= config.bin %> report conversations --start 2024-01-01T00:00:00Z --end 2024-01-31T23:59:59Z',
    '<%= config.bin %> report conversations --start 2024-01-01T00:00:00Z --end 2024-01-31T23:59:59Z --mailbox 1',
  ]
